  ...
  return (
    <div className="mx-auto max-w-[860px]">
      <div className="mb-3 flex items-center gap-2">
        ...
        <Link
          href="/new-booking"
          className="inline-flex whitespace-nowrap items-center rounded-[9px] border border-ink bg-ink px-[14px] py-[7px] font-display text-[12px] font-extrabold tracking-[.02em] text-white"
        >
          + New Booking
        </Link>
        <button
